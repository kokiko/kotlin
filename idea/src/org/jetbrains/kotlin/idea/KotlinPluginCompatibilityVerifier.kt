    ...
    fun checkCompatibility() {
        ...
        if (kotlinVersion.platformVersion.platform != platformVersion.platform) {
            Messages.showWarningDialog(
                "Installed Kotlin plugin version (TODO) is not compatible with $platformVersion.\n" +
...
private data class KotlinPluginVersion(
...
private data class PlatformVersion(val platform: Platform, val version: String /* 3.1 or 2017.3 */) {
    companion object {
